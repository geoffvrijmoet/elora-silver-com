  ...
  return (
    <main className="h-screen flex flex-col bg-muted-green-light text-gray-800">
      <div className="w-full max-w-7xl mx-auto p-4 flex flex-col flex-grow">
        {/* Header Section */}
        <header className="text-center p-4 bg-super-pale-green rounded-lg shadow-sm mb-4">
        ...
        <div className="flex-grow grid md:grid-cols-3 md:grid-rows-2 gap-4">
          ...
          <div className="md:row-span-2 bg-super-pale-green p-6 rounded-lg shadow-sm flex flex-col">
          ...
          <div className="md:col-span-2 bg-super-pale-green p-6 rounded-lg shadow-sm">
          ...
          <div className="bg-super-pale-green p-6 rounded-lg shadow-sm">
          ...
          <div className="bg-super-pale-green p-6 rounded-lg shadow-sm flex flex-col justify-center items-center text-center">
